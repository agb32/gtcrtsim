...
if ctrl.rank==0:
    ...
    execOrder=[PostdarcList[0],iscrnList[0],iatmosList[0],dmList[0],dmList[1],wfscentList[0],PredarcList[0],DarcList[0],scienceList[0],scienceList[1],scienceList[2],scienceList[3],iatmosList[1],dmList[2],dmList[3],scienceList[4],]
