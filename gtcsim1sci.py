...
if ctrl.rank==0:
    ...
    execOrder=[PostdarcList[0],infScrnList[0],infScrnList[1],infScrnList[2],infAtmosList[0],dmList[0],dmList[1],wfscentList[0],PredarcList[0],DarcList[0],scienceList[0],]
